 ...
 * org.openqa.selenium.firefox.FirefoxDriver; import org.testng.ITestResult;
 ...
 * com.aventstack.extentreports.util.Assert; import
 * com.relevantcodes.extentreports.LogStatus;
 * 
 * //It is possible to attach screenshots. To add a screen-shot, simply call
 * addScreenCapture. //This method returns the HTML with tag which can be used
 * anywhere in the log details.
 * 
 * 
 * public class ExtentReportsClass{
 * 
 * static ExtentReports extent; ExtentTest logger; WebDriver driver; static
 ...
 * //extent.addSystemInfo("Environment","Environment Name") extent
 ...
 * the code mentioned below extent.loadConfig(new
 ...
 * 
 * public void passTest(){ //extent.startTest("TestCaseName", "Description")
 * //TestCaseName – Name of the test //Description – Description of the test
 * //Starting test logger = extent.startTest("passTest");
 * Assert.assertTrue(true); //To generate the log when the test case is passed
 * logger.log(LogStatus.PASS, "Test Case Passed is passTest"); }
 * 
 * public void failTest(){ //My intention is to fail this method //If this
 * method fails, then it goes to the @AfterMethod and calls the getScreenshot
 * method and captures a screenshot and place it in the extent reports logger =
 * extent.startTest("failTest"); System.setProperty("webdriver.gecko.driver",
 * "D://Selenium//Drivers//geckodriver.exe"); driver = new FirefoxDriver();
 * driver.get("https://www.softwaretestingmaterial.com"); String currentURL =
 * driver.getCurrentUrl(); Assert.assertEquals(currentURL, "NoTitle");
 * logger.log(LogStatus.PASS, "Test Case (failTest) Status is passed"); }
 * 
 * public void skipTest(){ logger = extent.startTest("skipTest"); throw new
